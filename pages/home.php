...
<main class="main-content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-6 mb-5 mb-lg-0 pe-lg-5" data-aos="fade-right">
                    ...
                    <div class="text-center">
                        <a href="/nos-services" class="btn btn-gold btn-lg">Voir tous nos services</a>
                    </div>
                </div>
    ...
    <div class="container">
        ...
        <div class="text-center mt-5" data-aos="fade-up">
            <a href="/realisations" class="btn btn-gold btn-lg">Voir tous nos projets</a>
        </div>
    </div>
</section>
    ...
    <section class="hero-section hero-cta" style="background: linear-gradient(135deg, rgba(212,175,55,0.12), rgba(0,0,0,0)); padding: 12px 0;">
        <div class="container text-center">
            ...
            <a href="/realisations" class="btn btn-outline-gold btn-lg ms-3">Voir notre travail</a>
        </div>
    </section>
